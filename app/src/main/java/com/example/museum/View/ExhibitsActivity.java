...
import com.example.museum.Controller.ExhibitsAdapter;
import com.example.museum.Controller.ItemDecoration;
...
//                Toast.makeText(ExhibitsActivity.this,"dklfk",Toast.LENGTH_LONG).show();
    ...
    private void init(){
        ...
        exhibitList.add(new Exhibit(8,R.drawable.gaoyitu,"高逸图","唐 孙位\n尺寸:纵45.2cm 横168.7cm\n绢本"));
